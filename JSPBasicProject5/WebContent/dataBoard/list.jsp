...
<%
	...
	/*
		http://localhost/JSPBasicProject5/dataBoard/list.jsp 		 ===> null   비교(==)
		http://localhost/JSPBasicProject5/dataBoard/list.jsp?page=   ====> ""(공백) 비교(equals())
...
<link rel="stylesheet" href="../css/bootstrap.min.css"> <!--  이미 row는 정의되어잇다 -->
<style type="text/css">
