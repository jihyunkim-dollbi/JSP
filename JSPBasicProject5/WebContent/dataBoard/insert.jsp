...
<body>
	<div class="container">
		<h2>글쓰기</h2>
		<div class="row">
			<form method=post action="insert_ok.jsp" enctype="multipart/form-data">  <!-- enctype="multipart/form-data" -> 프로토콜-->
			...
			<table class="table table-hover">
				...
				<tr>
					<th width=20% class="text-right default success" >첨부파일</th>
					<td width=80%>
